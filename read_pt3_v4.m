...
case 2, cnt_2=cnt_2+1; dtime = bitand(bitshift(T3Record,-16),4095); delaytimes2(cnt_2)=dtime.*Resolution; 
...
%dlmwrite('D:\IntShifts new Tjaart\result AOM extraction\result',RealTimeHist,' '); 
